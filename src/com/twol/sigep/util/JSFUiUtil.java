...
public class JSFUiUtil {
	...
	public static void info(String msgResumida, String msgDetalhada) {
		JSFUiUtil.informar(null, msgResumida, msgDetalhada, FacesMessage.SEVERITY_INFO);
	}
	
	public static void info(String msg) {
		JSFUiUtil.informar(null, msg, msg, FacesMessage.SEVERITY_INFO);
	}
	
	public static void warn(String componente, String msgResumida, String msgDetalhada) {
		JSFUiUtil.informar(componente, msgResumida, msgDetalhada, FacesMessage.SEVERITY_WARN);
	}
	
	public static void warn(String msgResumida, String msgDetalhada) {
		JSFUiUtil.informar(null, msgResumida, msgDetalhada, FacesMessage.SEVERITY_WARN);
	}
	
	public static void warn(String msg) {
		JSFUiUtil.informar(null, msg, msg, FacesMessage.SEVERITY_WARN);
	}
	
	public static void error(String componente, String msgResumida, String msgDetalhada) {
		JSFUiUtil.informar(componente, msgResumida, msgDetalhada, FacesMessage.SEVERITY_ERROR);
	}
	
	public static void error(String msgResumida, String msgDetalhada) {
		JSFUiUtil.informar(null, msgResumida, msgDetalhada, FacesMessage.SEVERITY_ERROR);
	}
	
	public static void error(String msg) {
		JSFUiUtil.informar(null, msg, msg, FacesMessage.SEVERITY_ERROR);
	}
	
	public static void fatal(String componente, String msgResumida, String msgDetalhada) {
		JSFUiUtil.informar(componente, msgResumida, msgDetalhada, FacesMessage.SEVERITY_FATAL);
	}
	
	public static void fatal(String msgResumida, String msgDetalhada) {
		JSFUiUtil.informar(null, msgResumida, msgDetalhada, FacesMessage.SEVERITY_FATAL);
	}
	
	public static void fatal(String msg) {
		JSFUiUtil.informar(null, msg, msg, FacesMessage.SEVERITY_FATAL);
	}
